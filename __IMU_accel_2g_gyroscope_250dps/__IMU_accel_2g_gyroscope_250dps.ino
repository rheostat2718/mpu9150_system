...
void setup()
{
  ...
  MPU9150_writeSensor(0x1c, (MPU9150_readSensor(0x1c) & (~ 0x18 ) ) | (0*(1 << 4) + 0*(1 << 3)) )  ;  
  // set AFS_SEL[1:0] <0x1c,4-3> = 0; Full Scale Range of Accelerometers is +-2[g]
  MPU9150_writeSensor(0x1b, (MPU9150_readSensor(0x1b) & (~ 0x18 ) ) | (0*(1 << 4) + 0*(1 << 3)) );  
  // set FS_SEL[1:0] <0x1b,4-3> = 0; FSR of Gyroscope is +- 250[deg/s]
